...
namespace Neo.Utility.Extensions {
    public static class TransformExtensions {
        ...
        public static void BuildPath(this Transform self, System.Text.StringBuilder builder)
        {
            if (self.parent)
            {
        ...
        public static string BuildPath(this Transform self)
        {
            using (var builder = DataStructureLibrary<System.Text.StringBuilder>.Instance.CheckOut())
            {
                ...
                if (self.parent)
                {
                    BuildFullName(self.parent, builder.Value);
                    builder.Value.AppendFormat("/");
                }
